                            ...
                            {categories.map(category => {
                                return (
                                    <ul key={category.id} onClick={() => props.action === "upload" && selectCategory(category)}>
                                        ...
                                        :
                                            <Button className="cursor-pointer" icon={`pi ${category.link === null ? "pi-cloud-upload" : "pi-check"}`} rounded severity={category.link === null ? "" : "success"} onClick={() => selectCategory(category)}/>
                                        }
                                    </ul>
                                )
                            })}
